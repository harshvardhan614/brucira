...
const Pipeline = () => {
  return (
    <section className={`max-container padding-container relative my-20`}>
      <div
      ...
      >
        ...
        >
          {/* Content */}
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex items-start flex-col gap-6">
            <Button
              type="button"
              title="Use Case"
              icon=""
              variant="bg-violet-10 text-violet border-violet-10 font-semibold rounded-full"
            />
